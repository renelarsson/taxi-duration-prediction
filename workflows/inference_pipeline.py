...
if __name__ == "__main__":
    ...
    parser.add_argument('--taxi-type', default='yellow', help='Taxi type (yellow/green)')
    ...
    parser.add_argument('--start-year', type=int, default=2023, help='Backfill start year')
    parser.add_argument('--start-month', type=int, default=3, help='Backfill start month')
